...
Throughput_total = zeros(algorithm_counts, 4);
...
for i = 1 : 4
    ...
    % 对比算法1 ahpsaw
     disp('------------AHPSAW-------------');
    Throughput_total(2, i) = AHPSAW_Throughput(selected_numbers);
...
writematrix(Throughput_total,'D:\simulation\Throughoutput\Throughput.xlsx','Sheet','Throughput', 'WriteMode','replacefile');
