...
%% 纵坐标： 各类算法的基站负载程度
BSLoadDegree_BLQoE  = readmatrix('D:\simulation\BER\BER.xlsx','sheet','BER','Range','1:1');
BSLoadDegree_AHPSAW = readmatrix('D:\simulation\BER\BER.xlsx','Sheet','BER','Range','2:2');
BSLoadDegree_GRA = readmatrix('D:\simulation\BER\BER.xlsx','Sheet','BER', 'Range','3:3');
BSLoadDegree_RSR = readmatrix('D:\simulation\BER\BER.xlsx','Sheet','BER', 'Range','4:4');
